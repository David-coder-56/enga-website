        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <motion.p
              ...
              className="text-gray-700 dark:text-gray-400 text-lg font-light leading-relaxed mb-12"
            >
              ...
              {values.map((val, i) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-400 text-sm font-light leading-relaxed">{val.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
